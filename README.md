...
certificate chain.
    ...
    [admin@MikroTik] > / tool fetch "https://github.com/kiLL0-TS/tsn-mikrotik/blob/master/certs/Let's%20Encrypt%20Authority%20X3.pem" dst-path="letsencrypt.pem"
          status: finished
...
Now let's download the main scripts and add them in configuration on the fly.
    ...
    [admin@MikroTik] > :foreach Script in={ "global-config"; "global-config-overlay"; "global-functions"; "script-updates" } do={ / system script add name=$Script source=([ / tool fetch check-certificate=yes-without-crl ("https://github.com/kiLL0-TS/tsn-mikrotik/plain/" . $Script) output=user as-value]->"data"); }
